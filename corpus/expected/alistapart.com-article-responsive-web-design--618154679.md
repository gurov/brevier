...
But the landscape is shifting, perhaps more quickly than we might like. Mobile browsing is expected to outpace desktop-based access within [three](http://www.mediapost.com/publications/?fa=Articles.showArticle&art_aid=120590) to [five years](http://www.morganstanley.com/institutional/techresearch/mobile_internet_report122009.html). Two of the three dominant video game consoles have web browsers (and [one of them](http://www.nintendo.com/consumer/systems/wii/en_na/channelsInternet.jsp) is quite excellent). We’re designing for mice and keyboards, for T9 keypads, for handheld game controllers, for touch interfaces. In short, we’re faced with a greater number of devices, input modes, and browsers than ever before.
...
[![](https://i0.wp.com/alistapart.com/wp-content/uploads/2012/07/f-img-narrow.jpg?w=960&quality=89&ssl=1)](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-mini.html)

Our figures can responsively change their layout [to better suit smaller displays](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-mini.html).

Don’t mind the unsightly percentages; we’re simply recalculating the widths of the [fluid grid](http://www.alistapart.com/articles/fluidgrids/) to account for the newly linearized layout. In short, we’re [moving from a three-column layout to a two-column layout](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-mini.html) when the viewport’s width falls below `400px`, making the images more prominent.
...
Now our images are working beautifully [at both ends of the resolution spectrum](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-larger.html), optimizing their layout to changes in window widths and device resolution alike.

[![](https://i0.wp.com/alistapart.com/wp-content/uploads/2012/07/f-img-widescreen.jpg?w=960&quality=89&ssl=1)](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-larger.html)

By specifying a wider `min-width` in a new media query, we can shift our images into [a single row layout](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-larger.html).

But this is only the beginning. Working from the media queries we’ve embedded in our CSS, we can alter much more than the placement of a few images: we can [introduce new, alternate layouts](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-FINAL.html) tuned to each resolution range, perhaps making the navigation more prominent in a widescreen view, or repositioning it above the logo on smaller displays.

[![](https://i0.wp.com/alistapart.com/wp-content/uploads/2012/07/f-nav-narrow.jpg?w=960&quality=89&ssl=1)](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-FINAL.html)

By designing responsively, we can not only linearize our content on smaller devices, but also [optimize its presentation across a range of displays](https://alistapart.github.io/code-samples/responsive-web-design/ex/ex-site-FINAL.html).
