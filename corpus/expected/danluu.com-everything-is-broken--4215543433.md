...
The latch mechanism isn't quite flush to the door on about 10% of lockers, so your locker won't actually be latched unless you push hard against the door while moving the latch to the closed position (which means that, unless you check, it's easy to think you locked the locker door without having actually locked it; no doubt there's a helpful sign saying that they're not responsible for any theft that might occur).
...
![Unreadable quoted blocks](https://danluu.com/images/everything-is-broken/rust_guide.webp)
