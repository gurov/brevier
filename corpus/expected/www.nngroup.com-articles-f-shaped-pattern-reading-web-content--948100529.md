...
![Eyetracking heatmap of \"The 1900 Storm\" Galveston webpage. Red and yellow hotspots cluster on the first few lines of the main article and along the left edge of each paragraph, fading to blue further right and further down the page — the classic F-shaped reading pattern.](https://media.nngroup.com/media/editor/2017/11/08/read_image_1900storm_third_watermark.png)
...
![Eyetracking heatmap of the \"Tigers in Crisis\" webpage. Intense red and yellow fixations blanket the first three paragraphs of body text, tapering off further down. The banner ad at the top, the Dinty Moore ad in the right rail, and the Kinetico ad below it show virtually no attention — an illustration of banner blindness.](https://media.nngroup.com/media/editor/2017/11/08/tigersincrisis-heat_corrected_cropped_watermark.png)
...
![Eyetracking gaze plot of a History.com article, \"Remembering 9/11: 15 Years Later.\" Over 130 numbered fixation dots connected by lines cluster densely on the body text — especially the opening paragraph and the bulleted list of volunteers — while the video player, \"Trending Now\" sidebar, and top navigation go almost entirely unvisited.](https://media.nngroup.com/media/editor/2017/11/08/p14_kristine_history911_35secsegment_fpattern_cropped_watermark.png)
