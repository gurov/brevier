...
Async/await syntax in Rust was initially released to much fanfare and excitement. To quote [Hacker News](https://news.ycombinator.com/item?id=21473418) at the time:
...
Recently, the reception has been a bit more mixed. To a quote a comment on [Hacker News](https://news.ycombinator.com/item?id=37436413) again, discussing a recent blog post on the subject:
...
A third [Hacker News](https://news.ycombinator.com/item?id=37791635) comment represents well the kind of remark that I often see in this debate:
...
The initial attempt to implement this was to try to define a new trait, called `Move`, which would be used to exclude coroutines from APIs which can move them. This ran into some backwards compatibility problems that I have previously [documented](https://without.boats/blog/changing-the-rules-of-rust). My thesis for async/await had three main points:
